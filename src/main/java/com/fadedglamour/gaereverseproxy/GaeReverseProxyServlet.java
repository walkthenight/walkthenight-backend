package com.fadedglamour.gaereverseproxy;
...
public class GaeReverseProxyServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5062759845194300801L;
	...
	/** A boolean parameter name to enable logging of input and target URLs to the servlet log. */
	  ...
	  protected static final String ATTR_TARGET_URI =
			  GaeReverseProxyServlet.class.getSimpleName() + ".targetUri";
	  protected static final String ATTR_TARGET_HOST =
			  GaeReverseProxyServlet.class.getSimpleName() + ".targetHost";
	  ...
	  private URLFetchService proxyFetchService= URLFetchServiceFactory.getURLFetchService();
	...
	//  private HttpClient proxyClient;
	  ...
	  public String getServletInfo() {
	    return "A proxy servlet originally by David Smiley, dsmiley@apache.org, rewritten for Google App Engine by si@fadedglamour.com";
	  }
...
//	      proxyRequest = new BasicHttpRequest(method, proxyRequestUri);
	    ...
	    HTTPRequest proxyRequest= new HTTPRequest(new URL(proxyRequestUri));
	    ...
	    try {
	      // Execute the request
	      if (doLog) {
	        log("proxy " + method + " uri: " + servletRequest.getRequestURI() + " -- " + proxyRequest.getURL());
	      }
	      proxyResponse = proxyFetchService.fetch(proxyRequest);

	      // Process the response
	      int statusCode = proxyResponse.getResponseCode();
...
//	        consumeQuietly(proxyResponse.getContent());
	  ...
	  protected boolean doResponseRedirectOrNotModifiedLogic(
	    ...
	    if (statusCode >= HttpServletResponse.SC_MULTIPLE_CHOICES /* 300 */
	      ...
	      HTTPHeader locationHeader = getLastHeader(proxyResponse, HttpHeaders.LOCATION);
	  ...
	  private HTTPHeader getLastHeader(HTTPResponse proxyResponse, String headerName) {
		HTTPHeader result= null;
		
		for (HTTPHeader header : proxyResponse.getHeadersUncombined()) {
...
//	  }
	   ...
	   */
	  protected static final List<String> hopByHopHeaders;
	  static {
	    hopByHopHeaders = new ArrayList<String>();
	  ...
	  private void setXForwardedForHeader(HttpServletRequest servletRequest,
	    ...
	    if (doForwardIP) {
	      ...
	      proxyRequest.setHeader(new HTTPHeader(headerName, newHeader));
	    }
	  }
	  ...
	  protected void copyResponseHeaders(HTTPResponse proxyResponse, HttpServletRequest servletRequest,
	    ...
	    for (HTTPHeader header : proxyResponse.getHeaders()) {
	      if (hopByHopHeaders.contains(header.getName()))
	        continue;
	  ...
	  protected void copyProxyCookie(HttpServletRequest servletRequest,
	                                 HttpServletResponse servletResponse, HTTPHeader header) {
